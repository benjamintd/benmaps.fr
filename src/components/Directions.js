...
class Directions extends Component {
  render() {
    return (
      <div id="directions">
                    ...
                    <PlaceName
                      ...
                      onClick={() => {
                        this.props.writeSearchFrom(
                          this.props.directionsFrom.place_name
                        );
                    ...
                    <PlaceName
                      ...
                      onClick={() => {
                        this.props.writeSearchTo(
                          this.props.directionsTo.place_name
                        );
        ...
        {this.props.route ||
        this.props.routeStatus === "pending" ||
  ...
  setUserLocationDirections() {
    if (!this.props.directionsFrom)
      this.props.setDirectionsLocation("from", this.props.userLocation);
    else if (!this.props.directionsTo)
      this.props.setDirectionsLocation("to", this.props.userLocation);
    this.props.triggerMapUpdate("repan");
  }
  ...
  showUserLocation() {
    return (
      ((!this.props.directionsFrom && !this.props.directionsTo) ||
        (!this.props.directionsTo &&
          this.props.directionsFrom &&
          this.props.directionsFrom.place_name !== "My Location") ||
        (!this.props.directionsFrom &&
          this.props.directionsTo &&
          this.props.directionsTo.place_name !== "My Location")) &&

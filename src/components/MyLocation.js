...
class MyLocation extends Component {
  render() {
    return (
      <div
        className='fixed bg-white shadow-darken5 border-darken10 bg-gray-faint-on-hover sub-menu h36 flex-parent flex-parent--center-cross pr12 cursor-pointer w-full w420-ml'

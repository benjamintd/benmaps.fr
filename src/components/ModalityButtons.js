...
class ModalityButtons extends Component {
  render() {
    return (
      <div className='directions-modality color-white h72 px42 p18 w-full w420-ml flex-parent flex-parent--row flex-parent--center-main flex-parent--center-cross'>
      {
